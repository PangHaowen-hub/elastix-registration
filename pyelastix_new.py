...
def register(im1, im2, params, exact_params=False, verbose=1, TransformParameters_path=None, mask1=None, mask2=None):
    ...
    * verbose (int):
    ...
    shutil.copy(path_trafo_params, TransformParameters_path)  # TODO：保存路径
    # Clean and return
    _clear_temp_dir()
    return a, fields
